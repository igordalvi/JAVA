...
public class DontForgetToStoreIt {
    public static void main(String[] args) {
        ...
        double pi = 3.14159;
        String cheese, color, meaningOfLifeAndEverythingString, piString;

        Scanner inputReader = new Scanner(System.in);

        System.out.println("Give me pi to at least 5 decimals: ");
        piString = inputReader.next();
        pi = Double.parseDouble(piString);
        ...
        meaningOfLifeAndEverythingString = inputReader.next();
        meaningOfLifeAndEverything  = Integer.parseInt(meaningOfLifeAndEverythingString);
